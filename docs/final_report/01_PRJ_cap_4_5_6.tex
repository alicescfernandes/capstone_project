...
\subsection{Conversão e Exportação para \gls{json}}
- Falar sobre a transformação do pandas\n
- Falar da exportação do \gls{json}\n
- Falar da gestão de ficheiro \gls{xlsx}, e metodologias para não haver conflito entre ficheiros carregados\n
...
- QA em alguns gráficos de modo a garantir que os dados estão a ser processados corretamente.
