...
A aplicação demonstrou compatibilidade com os \textit{browsers} testados, com exceção do Internet Explorer 11, que não é suportado devido a limitações técnicas e à baixa utilização atual deste navegador.
...
\begin{itemize}
    ...
    \item Compatibilidade robusta com \textit{browsers} modernos
