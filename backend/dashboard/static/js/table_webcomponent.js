(()=>{var y=Object.defineProperty,x=Object.defineProperties;var C=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var w=Object.prototype.hasOwnProperty,g=Object.prototype.propertyIsEnumerable;var v=(r,t,e)=>t in r?y(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,o=(r,t)=>{for(var e in t||(t={}))w.call(t,e)&&v(r,e,t[e]);if(h)for(var e of h(t))g.call(t,e)&&v(r,e,t[e]);return r},u=(r,t)=>x(r,C(t));var m=(r,t)=>{var e={};for(var a in r)w.call(r,a)&&t.indexOf(a)<0&&(e[a]=r[a]);if(r!=null&&h)for(var a of h(r))t.indexOf(a)<0&&g.call(r,a)&&(e[a]=r[a]);return e};var p=(r,t,e)=>new Promise((a,n)=>{var l=i=>{try{s(e.next(i))}catch(c){n(c)}},d=i=>{try{s(e.throw(i))}catch(c){n(c)}},s=i=>i.done?a(i.value):Promise.resolve(i.value).then(l,d);s((e=e.apply(r,t)).next())});var T=`${window.location.origin}/api/`,f=document.createElement("style");f.textContent=`
    .dt-column-header {
        position: relative;
        display: flex;
        align-items: center;
...
`;document.head.appendChild(f);window.$.fn.dataTable&&(window.$.fn.dataTable.ext.errMode="none");var b=class extends HTMLElement{constructor(){super(),this.initState(),this.id=`table_${this.state.chartSlug}`,this.table=null,this.zoomTable=null}initState(){this.state={chartSlug:this.getAttribute("chart_slug"),quarterNumber:this.getAttribute("q"),data:[],columns:[],isError:!1,isLoading:!0,quarter:{current:"1",prev:null,next:null},dataTableSettings:{responsive:!0,searching:!0,ordering:!0,paging:!0,destroy:!0,debug:!1,pageLength:5,lengthChange:!1,search:{smart:!1,caseInsensitive:!0},searchCols:[],language:{search:"Search table:"}}}}static get observedAttributes(){return["chart_slug","q"]}connectedCallback(){this.setupLazyLoad()}fetchData(){return p(this,null,function*(){let t=new URLSearchParams(o({slug:this.state.chartSlug,q:this.state.quarterNumber},this.state.selectedOption&&{opt:this.state.selectedOption}));try{let a=yield fetch(`${T}chart/?${t.toString()}`);if(!a.ok)throw new Error(`HTTP error! Status: ${a.status}`);let n=yield a.json();console.log("data",n);let e=n,{selected_option:l}=e,d=m(e,["selected_option"]);this.setState(o({selectedOption:l||""},d))}catch(a){this.setState({isError:!0})}finally{this.setState({isLoading:!1})}})}setState(t){this.state=o(o({},this.state),t),this.render()}renderSpinner(){return`<div class="spinner-container" role="status">
        ...
        `}render(){if(this.state.isLoading){this.innerHTML=this.renderSpinner();return}if(this.state.isError){this.innerHTML=this.renderError();return}let t=`
            ...
            </div>`;console.log("newHTML",t),this.innerHTML=t,this.initializeTable(),this.setupEvents(),this.renderQuarterNavigation()}renderQuarterNavigation(){let{quarter:t}=this.state;return`
        ...
        `}waitForDataTables(){return window.DataTable?Promise.resolve():new Promise(t=>{let e=()=>{window.DataTable?t():setTimeout(e,500)};e()})}initializeTable(){return p(this,null,function*(){if(this.table)return;yield this.waitForDataTables();let t=this.querySelector(`#${this.id} table`);t&&($.fn.DataTable.isDataTable(t)||(this.table=new DataTable(`#${this.id} table`,u(o({data:this.state.data,columns:this.state.columns},this.state.dataTableSettings),{searchCols:this.state.columns.map(()=>({search:""}))}))))})}setupEvents(){var l,d;(l=this.querySelector(`#${this.id} .prev-quarter`))==null||l.addEventListener("click",()=>this.handleQuarterChange("prev")),(d=this.querySelector(`#${this.id} .next-quarter`))==null||d.addEventListener("click",()=>this.handleQuarterChange("next"));let t=this.querySelector(`#${this.id} .chart-zoom-btn`),e=this.querySelector(`#${this.id} .chart-zoom-overlay`),a=this.querySelector(`#${this.id} .chart-zoom-container`),n=this.querySelector(`#${this.id} .chart-zoom-close`);t.addEventListener("click",()=>{e.style.display="flex";let s=a.querySelector("table");window.DataTable&&(s.dataset.initialized||(this.zoomTable=new DataTable(s,u(o({data:this.state.data},this.state.dataTableSettings),{pageLength:10,lengthChange:!0,search:{smart:!1,caseInsensitive:!0},searchCols:this.state.columns.map(()=>({search:""})),dom:"Bfrtip",columnControl:["order",["orderAsc","orderDesc","search"]],buttons:[{extend:"colvis",text:"Show/Hide Columns",className:"btn btn-primary",columns:":gt(0)"}],columns:this.state.columns})),s.dataset.initialized="true"))}),n.addEventListener("click",()=>{e.style.display="none";let s=a.querySelector("table");window.$&&window.$.fn.DataTable&&window.$.fn.DataTable.isDataTable(s)&&(window.$(s).DataTable().destroy(),s.dataset.initialized="")}),document.addEventListener("keydown",s=>{if(s.key==="Escape"||s.key==="Esc"){e.style.display="none";let i=a.querySelector("table");window.$&&window.$.fn.DataTable&&window.$.fn.DataTable.isDataTable(i)&&(window.$(i).DataTable().destroy(),i.dataset.initialized="")}})}handleQuarterChange(t){var a;let e=(a=this.state.quarter)==null?void 0:a[t];e&&(this.setState({quarterNumber:e}),this.fetchData())}setupLazyLoad(){new IntersectionObserver((e,a)=>{for(let n of e)n.isIntersecting&&(this.loadTable(),a.unobserve(this))},{root:null,rootMargin:"100px",threshold:.1}).observe(this)}loadTable(){this.state.isLoading&&(this.fetchData(),this.render())}disconnectedCallback(){this.table&&(this.table.destroy(),this.table=null)}};customElements.define("data-table",b);})();
