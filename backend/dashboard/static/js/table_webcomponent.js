(()=>{var z=Object.defineProperty,L=Object.defineProperties;var q=Object.getOwnPropertyDescriptors;var p=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,y=Object.prototype.propertyIsEnumerable;var f=(r,t,e)=>t in r?z(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,d=(r,t)=>{for(var e in t||(t={}))x.call(t,e)&&f(r,e,t[e]);if(p)for(var e of p(t))y.call(t,e)&&f(r,e,t[e]);return r},C=(r,t)=>L(r,q(t));var T=(r,t)=>{var e={};for(var a in r)x.call(r,a)&&t.indexOf(a)<0&&(e[a]=r[a]);if(r!=null&&p)for(var a of p(r))t.indexOf(a)<0&&y.call(r,a)&&(e[a]=r[a]);return e};var v=(r,t,e)=>new Promise((a,n)=>{var c=i=>{try{l(e.next(i))}catch(s){n(s)}},o=i=>{try{l(e.throw(i))}catch(s){n(s)}},l=i=>i.done?a(i.value):Promise.resolve(i.value).then(c,o);l((e=e.apply(r,t)).next())});var D=`${window.location.origin}/api/`,k=document.createElement("style");k.textContent=`
    .dt-column-header {
        position: relative;
        display: flex;
        align-items: center;
