(()=>{var x=Object.defineProperty,y=Object.defineProperties;var T=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var v=Object.prototype.hasOwnProperty,w=Object.prototype.propertyIsEnumerable;var b=(r,t,e)=>t in r?x(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,o=(r,t)=>{for(var e in t||(t={}))v.call(t,e)&&b(r,e,t[e]);if(h)for(var e of h(t))w.call(t,e)&&b(r,e,t[e]);return r},g=(r,t)=>y(r,T(t));var m=(r,t)=>{var e={};for(var a in r)v.call(r,a)&&t.indexOf(a)<0&&(e[a]=r[a]);if(r!=null&&h)for(var a of h(r))t.indexOf(a)<0&&w.call(r,a)&&(e[a]=r[a]);return e};var u=(r,t,e)=>new Promise((a,n)=>{var l=s=>{try{i(e.next(s))}catch(c){n(c)}},d=s=>{try{i(e.throw(s))}catch(c){n(c)}},i=s=>s.done?a(s.value):Promise.resolve(s.value).then(l,d);i((e=e.apply(r,t)).next())});var C=`${window.location.origin}/api/`,f=document.createElement("style");f.textContent=`
    .dt-column-header {
        position: relative;
        display: flex;
        align-items: center;
...
`;document.head.appendChild(f);window.$.fn.dataTable&&(window.$.fn.dataTable.ext.errMode="none");var p=class extends HTMLElement{constructor(){super(),this.initState(),this.id=`table_${this.state.chartSlug}`,this.table=null,this.zoomTable=null}initState(){this.state={chartSlug:this.getAttribute("chart_slug"),quarterNumber:this.getAttribute("q"),data:[],columns:[],isError:!1,isLoading:!0,quarter:{current:"1",prev:null,next:null},dataTableSettings:{responsive:!0,searching:!0,ordering:!0,paging:!0,destroy:!0,debug:!1,pageLength:5,lengthChange:!1,search:{smart:!1,caseInsensitive:!0},searchCols:[],language:{search:"Search table:"}}}}static get observedAttributes(){return["chart_slug","q"]}connectedCallback(){this.setupLazyLoad()}fetchData(){return u(this,null,function*(){let t=new URLSearchParams(o({slug:this.state.chartSlug,q:this.state.quarterNumber},this.state.selectedOption&&{opt:this.state.selectedOption}));try{let a=yield fetch(`${C}chart/?${t.toString()}`);if(!a.ok)throw new Error(`HTTP error! Status: ${a.status}`);let n=yield a.json();console.log("data",n);let e=n,{selected_option:l}=e,d=m(e,["selected_option"]);this.setState(o({selectedOption:l||""},d))}catch(a){this.setState({isError:!0})}finally{this.setState({isLoading:!1})}})}setState(t){this.state=o(o({},this.state),t),this.render()}renderSpinner(){return`<div class="spinner-container" role="status">
